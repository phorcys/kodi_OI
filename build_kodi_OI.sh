...
CC=gcc CXX=g++ LD=/usr/gnu/bin/ld PKG_CONFIG_PATH=/usr/local/lib/pkgconfig:$PKG_CONFIG_PATH PATH=/usr/mariadb/5.5/bin:$PATH bash configure --prefix=~/kodi/build/ --disable-ssh LDFLAGS="-L/usr/lib -L/usr/local/lib -L/usr/sfw/lib"
